...
! function(t) {
  t.fn.seatCharts = function(s) {
    ...
    return e.append(c), t.each(i.map, function(s, c) {
      ...
      i.naming.left && u.append(t("<div></div>").addClass("seatCharts-cell seatCharts-space seatCharts-rowHeader").text(i.naming.rows[s])), t.each(c.match(/[a-z_]{1}(\[[0-9a-z_]{0,}(,[0-9a-z_ ]+)?\])?/gi), function(e, c) {
